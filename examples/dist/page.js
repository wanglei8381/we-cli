...
var lifecycleHooks = ['onLoad', 'onReady', 'onShow', 'onHide', 'onUnload', 'onPullDownRefresh', 'onReachBottom', 'onShareAppMessage'];
...
Page.createInstance = function (options) {
  ...
  var _loop = function _loop(_i) {
    var hook = lifecycleHooks[_i];
    var handlers = options[hook];
  ...
  for (var _i = 0; _i < lifecycleHooks.length; _i++) {
    _loop(_i);
  }
  return Page(options);
};
